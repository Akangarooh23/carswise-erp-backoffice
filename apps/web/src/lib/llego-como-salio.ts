/**
 * ¿Llegó como salió? El espejo de `apps/api/src/lib/llego-como-salio.ts`.
 *
 * Duplicado porque los dos lados se compilan por separado. Lo que hay que
 * sostener es que **piden y dicen lo mismo**: si la pantalla dejara marcar
 * «Entregado» con algo que el servidor rechaza, el botón parecería roto.
 *
