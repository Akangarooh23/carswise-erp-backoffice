 ...
 *
 * Espejo de `apps/api/src/lib/partidas-de-la-gestoria.ts`, duplicado porque los
 * dos lados se compilan por separado. Lo que hay que sostener es que **suman
 * igual**: si un lado dejara de separar los suplidos, el total de la pantalla y
 * el coste del coche dirían cosas distintas sobre el mismo dinero.
 *
