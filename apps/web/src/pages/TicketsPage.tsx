    ...
    <div>
      ...
      <div className="bg-white rounded-xl border border-brand-200 shadow-sm overflow-hidden">
        {loading ? (
          ...
          <div className="text-center py-12 text-brand-300 text-sm">Sin tickets</div>
        ) : (
          <>
                ...
                {tickets.map((t) => (
                  <tr key={t.id}>
                    ...
                    <td>
                      ...
                      {t.user_email && <p className="text-xs text-brand-300">{t.user_email}</p>}
                    </td>
      ...
      <Modal open={showCreate} onClose={() => setShowCreate(false)} title="Nuevo ticket">
        <div className="space-y-4">
          <div>
            <label className="block text-xs font-medium text-brand-400 mb-1">ID de usuario *</label>
          ...
          <div>
            <label className="block text-xs font-medium text-brand-400 mb-1">Descripción *</label>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-medium text-brand-400 mb-1">Canal</label>
            ...
            <div>
              <label className="block text-xs font-medium text-brand-400 mb-1">Prioridad</label>
